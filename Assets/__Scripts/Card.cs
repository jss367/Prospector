...
public class Card : MonoBehaviour {
	...
	//This List holds all of the Decoraotr GameObjects
...
public class CardDefinition {
	...
	// Because decorators (from the XML) are used the same way on every card in the deck, pips
	// only stores information about the pips on numbered cards
}
